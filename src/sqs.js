import {hash, getSignatureKey, hmac, createCanonicalRequest, createStringToSign} from './utils.js';
...
export async function sendMessageToSQS(now, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY) {
  ...
  const params = new URLSearchParams({
    Action: 'SendMessage',
    MessageBody: JSON.stringify({ message: 'Hello refactor from Cloudflare Worker!' }),
    Version: '2012-11-05',
  });
